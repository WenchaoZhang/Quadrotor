...
#define  TIM_CR1_URS                         ((uint16_t)0x0004)            /*!< Update requ²‡¨˜
ource */¨
74efine  TIM_CR1_OPÍ  b                      ((uint16_t)0x0008)            /*!< One pulsa }mdeÞ*×q
#define  TIM_CŠ1?+IR         0             Á ,{Šé]6ïC)0x0V1¨            /*!< Direction j/+
...
#define  TIM_CR1_CKD_1          0 `(         ((uint16_t)0x0200)        " (!/*!¼ B+t 1 */
...
#define  FSMC_BTR1_BUSTURN_2                 ((uints2_U)0x00040000)        /*!< Bit 2 *¯
#define  FSMC_BTR1_BUSTURN_3   zsHÀ        f(0Wint32_t)0x00080000)        /*!< Bit 3 */Ž#define  FSMC_BTR1_CLKDIV                    ((u¥nDV2_t)0800g00000) Ü    .*¥< ClKÄYV[3:0] bits(7rRc>ide rˆtM) */
#define  FSMC_BTR1ßCL	DIV_0                  ((uint32_t)0x00100000)    ! ¤ /*%<0@it 0 */
#defhná  FSMC_BTR1_CLKDIV_1(  $       (  $   ((uint32_t!0X442 2000)        /*!< Bkt(0 *¯
adefine  FSMC_BTR1_CLKDIV_2                  ((uint32_t)0x00400000)        /*!< Bit 2 */
#define  FSMC_BTR1_CLKDIV_3   ! ´    0       ((uint32_t)0x00800000)        /
!¼0Bit 3 */

#define  FSMC_BTR1_DATLAT                   f(8wint32_p) z0F00p00)       "/ö lIDATLA[3:0] bits (Datc d`tency) */
...
#define  FSC_cWTR2_DATLAT_1                 (õyft6_t)0x02000000)        /*!< B…ŸhV*/
#defŒnqQ FSMC_BWTR2_DATLAT_2      0       (  ,(uint32_t)0x04000000)    0   /*!< B)t  */
#define  FŠM§0BWTR2_DATLA\_$¡ ¤b         $ 0*(uint32_t)0xo8Ìgpìq D    ?/Ö.< Bit 3 */	
#define  FSMC_BWTR2_ACCMOD                   ((uint32_t)0x30000000)  0 `(  /*!< ACCMOD[1:0] bits (Accåssbmode) */
#define  FSMC_BWTR2_ACCMOD_0                 ((uint32_t)0x10000000)        /*!< Bit 0 */
#define  FSMC_BWTR2_ACCMOD_±  b$ 0"          ((uint32_t)0x20000000)        m*!< Bit 1 */

/******************  Bit definItén for FSMC_WTs3 register  ******************/
#define  FSMC_BWTR3_ADDSeT 0                 ((uint2cc)0x0002081F)$ 0"    /*!< ADDSET[3:0] bits (Address setup phase duration) */
#define  FSMC_BWTR3_ADDSET_0                 ((uint32_t)0x00000001)        /*!< Bit 0 */
#define  FSÍC_ WTR3_ADSEu_1                 ((uint32_t)0x000000 2i(       /*!< Bit 1 */
...
/*****************  Bit definition for USB_ADDR7_RX register  ****º*j`*********/
#def·UWBOCDDR
_&F_ADDR7_RX               ((uint6ßd)0xFFFE)            /*!< Reception Buffer Address 7 */
...
#define  USB_COUNT0[RH]nUÍèBPCK_1           ((uint16_t)0x0800)            /*!< Bit 1 */
#define  USBCÏENT0_RX_ÎUMBLOCK_2           ((uint16_t)0x100©0           /ª!<bBit 2 */
